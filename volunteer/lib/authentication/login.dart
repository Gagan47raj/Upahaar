...
import 'package:volunteer/mainScreen/homeScreen.dart';
  ...
  Future readDataAndSetDataLocally(User currentUser) async 
  {
    ...
    .then((snapshot) async{
      if(snapshot.exists)
      {
         ...
         await sharedPreferences!.setString("email", snapshot.data()!["volunteerEmail"]);
         await sharedPreferences!.setString("name", snapshot.data()!["volunteerName"]);
         await sharedPreferences!.setString("photoUrl", snapshot.data()!["volunteerAvatarUrl"]); 
