...
import 'package:volunteer/mainScreen/creditScreen.dart';
...
class _HomeScreenState extends State<HomeScreen>
{
      ...
      child: Container(
        ...
        child: InkWell(
          onTap: ()
          {
            ...
            {
              //Total Earnings
              Navigator.push(context, MaterialPageRoute(builder: (c)=> const CreditsScreen()));
            }
            if(index == 5)
            {
              //Logout
  ...
  getRiderPreviousEarnings()
  {
    FirebaseFirestore.instance
        ...
        .get().then((snap)
    {
      previousVolunteerCredits = snap.data()!["earnings"].toString();
    });
  }
  ...
  getPerParcelDeliveryAmount()
  {
    FirebaseFirestore.instance
        ...
        .get().then((snap)
    {
       perParcelDeliveryCredit = snap.data()!["amount"].toString();
    });
  }
