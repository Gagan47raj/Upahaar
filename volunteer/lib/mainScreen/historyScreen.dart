...
import 'package:volunteer/assistantMethods/assistant_methods.dart';
import 'package:volunteer/widgets/progress_bar.dart';
              ...
              itemBuilder: (c, index)
              {
                return FutureBuilder<QuerySnapshot>(
                  future: FirebaseFirestore.instance
                      .collection("items")
                      .where("itemID", whereIn: separateOrderPostIDs((snapshot.data!.docs[index].data()! as Map<String, dynamic>) ["productIDs"]))
